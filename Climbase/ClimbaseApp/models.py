...
class Isincompetition(models.Model):
    routeid = models.OneToOneField('Route', models.DO_NOTHING, db_column='RouteId', primary_key=True)  # Field name made lowercase. The composite primary key (RouteId, CompetitionId) found, that is not supported. The first column is selected.
    competitionid = models.ForeignKey(Competition, models.DO_NOTHING, db_column='CompetitionId')  # Field name made lowercase.
...
class Judged(models.Model):
    competitionid = models.OneToOneField(Competition, models.DO_NOTHING, db_column='CompetitionId', primary_key=True)  # Field name made lowercase. The composite primary key (CompetitionId, UserId) found, that is not supported. The first column is selected.
...
class Score(models.Model):
    competitorid = models.IntegerField(db_column='CompetitorId', primary_key=True)  # Field name made lowercase. The composite primary key (CompetitorId, RouteId, CompetitionId) found, that is not supported. The first column is selected.
